...
\begin{itemize}
\item \textcolor{dc!70!black}{$\boldsymbol{X}$}:  $n\times p$ design matrix 
\item \textcolor{lt!70!black}{$\boldsymbol{Y}$}:  $n\times q$  response matrix 
\end{itemize}
...
```{r}
devtools::install_github("MariePerrotDockes/VariSel")
```
