...
subtitle: "Or how a Gallic village stay irreductible"
  ...
  \begin{tikzpicture}[node distance = 2cm, auto]
    % nodes
     \node(DC){\includegraphics[width= 0.22\textwidth]{cellule_dend}}; 
      \node[left of = DC, node distance = 3 cm,  color = gray](Pert){\includegraphics[width= 0.17\textwidth]{romain.png}}; 
...
\begin{itemize}
\item $\boldsymbol{X}$:  $n\times p$ design matrix \includegraphics[width =0.12\textwidth]{cellule_dend}
\item $\boldsymbol{Y}$:  $n\times q$  response matrix \includegraphics[width =0.12\textwidth]{ast_ob}
\end{itemize}
...
\item Let all variables 'free', without assoicaiting any of them
\end{itemize}
